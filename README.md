...
5. Предметы перемещаются по слотам инвентаря, и все изменения отображаются на списке предметов
...
ItemData: ScriptableObject. Содержит следующую информациб о предмете:
- Наименование
- Описание
- Спрайт
- Тип (enum)
- Булево поля для указания возможности стакаться
